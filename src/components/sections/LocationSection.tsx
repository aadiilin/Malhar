        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <AnimatedSection direction="left">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              Serving the Community of <span className="text-primary dark:text-primary-light">Vellamchira, Thodupuzha</span>
            </h2>
            ...
            <div className="flex items-start gap-3">
              <Award className="w-5 h-5 text-accent-dark shrink-0 mt-1" />
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((s, i) => (
                <Card key={s.label} className={`text-center ${i === stats.length - 1 ? "col-span-2" : ""}`}>
                  <s.icon className="w-8 h-8 mx-auto mb-2 text-primary dark:text-primary-light" />
