        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection direction="left">
            ...
            <div className="space-y-4 mb-8">
              ...
              <a href="mailto:info@malharulislamacademy.com" className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-emerald-600 transition-colors">info@malharulislamacademy.com</p>
                </div>
              </a>
              <a href="tel:+919446XXXXXX" className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-emerald-600 transition-colors">+91 9446XXXXXX</p>
                </div>
              </a>
            </div>
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="gold" size="lg" icon={<MessageCircle className="w-5 h-5" />} href="https://wa.me/919446XXXXXX">
                WhatsApp
              </Button>
            </div>
          </AnimatedSection>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input type="text" placeholder="Your Name" required
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/50 outline-none" />
                ...
                <textarea rows={4} placeholder="Your Message" required
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/50 outline-none resize-none" />
